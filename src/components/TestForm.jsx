...
const TestForm = () => {
    ...
    const [attemptLeft] = useState(user.freeTestsRemaining);
    const [isPremium] = useState(user.planType);
    const buttonText = isPremium === "free" ? attemptLeft > 0 ? `${attemptLeft} tests remaining` : "Upgrade" : "Generate Prashn Patra";
    ...
    const handleSubmit = async (e) => {
        ...
        if ((user.planType === "free" && user.freeTestsRemaining > 0) || user.planType === "premium") {
            ...
            toast.error("No remaining free tests.");
        }
